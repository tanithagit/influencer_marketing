...
function BrandLayout({ children }) {
  ...
  const navItems = [
    { path: '/brand/dashboard',    icon: LayoutDashboard, label: 'Dashboard'    },
    { path: '/brand/campaigns',    icon: Megaphone,       label: 'Campaigns'    },
    { path: '/brand/applications', icon: Users,           label: 'Applications' },
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-purple-600 font-medium">Brand Portal</p>
            </div>
          </div>
        </div>
