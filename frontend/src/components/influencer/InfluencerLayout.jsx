...
function InfluencerLayout({ children }) {
  ...
  const navItems = [
    { path: '/influencer/dashboard',    icon: LayoutDashboard, label: 'Dashboard'    },
    { path: '/influencer/campaigns',    icon: Search,          label: 'Browse'       },
    { path: '/influencer/applications', icon: FileText,        label: 'Applications' },
    { path: '/influencer/deliverables', icon: Upload,          label: 'Deliverables' },
